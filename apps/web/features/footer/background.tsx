...
export function Background() {
  return (
    <div className="pointer-events-none -z-10 max-h-[120%] overflow-hidden md:absolute md:bottom-0 md:left-0 md:right-0">
      <img
        src="/gradients/d-footer.webp"
        alt=""
        className="size-full translate-y-1/4 object-cover object-center md:translate-y-0"
        loading="lazy"
        width={1440}
        height={942}
      />
      <div className="max-width absolute inset-0">
        <Canvas
          dpr={[1, 1.5]}
