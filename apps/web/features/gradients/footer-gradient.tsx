const gradients = {
  ...
  dark: {
    background: `
      linear-gradient(0deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 1) 70%),
      linear-gradient(90deg, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 15%, rgba(0, 0, 0, 0) 85%, rgba(0, 0, 0, 1) 100%),
      linear-gradient(90deg, rgba(255, 38, 112, 0.6) 0%, rgba(121, 22, 243, 0.6) 100%)
    `,
    backgroundSize: '100% 100%',
    backgroundRepeat: 'no-repeat',
  },
